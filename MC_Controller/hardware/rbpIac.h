...
typedef enum{
	CONV_MOTOR1 = PCA6985_1,
	CONV_MOTOR2 = PCA6985_2,
	CONV_MOTOR3 = PCA6985_3,
	CONV_MOTOR4 = PCA6985_4,
	CONV_MOTOR5 = PCA6985_5,
	CONV_NONE,
} convMotor;
...
#define ELEV_MOTOR3_PWM	1
typedef enum{
	ELEV_MOTOR1 = PCA6985_4,
	ELEV_MOTOR2 = PCA6985_5,
	ELEV_MOTOR3 = ELEV_MOTOR3_PWM,
	ELEV_NONE,
} elevMotor;
...
void rbpCylinder(int ndev, int state);

void rbpLed(int ndev, int state);
...
void ConveyorMotorMove(int position);

void ConveyorMotorStop(int position);
