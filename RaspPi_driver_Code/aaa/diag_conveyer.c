...
int main (void)
{
	...
	rbpButton(CONV_BUTTON1, &button1_event1);
	rbpButton(CONV_BUTTON2, &button2_event1);
	rbpButton(CONV_BUTTON3, &button3_event1);
	rbpButton(CONV_BUTTON4, &button4_event1);
	rbpButton(CONV_BUTTON5, &button5_event);
	rbpButton(CONV_BUTTON6, &button6_event);
