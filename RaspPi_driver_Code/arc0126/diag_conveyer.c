...
int main (void)
{
	...
	rbpButton(CONV_BUTTON1, &button1_event);
	rbpButton(CONV_BUTTON2, &button2_event);
	rbpButton(CONV_BUTTON3, &button3_event);
	rbpButton(CONV_BUTTON4, &button4_event);
