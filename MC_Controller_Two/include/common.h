...
#define MAX_THREAD_NUM 7
	...
	#define SUBSCRIBE_TOPIC_SELF_IP "192.168.1.13"
	#define CLIENTID    "Module Control:Conveyor_Two"
	...
	#define SUBSCRIBE_TOPIC_SELF_IP "192.168.1.14"
	#define CLIENTID    "Module Control:Elevator_Two"
